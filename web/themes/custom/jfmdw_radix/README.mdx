...
jfmdw_radix theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of jfmdw_radix theme and run the following commands:
`nvm use`
...
`drush en jfmdw_radix -y`
`drush config-set system.theme default jfmdw_radix -y`
